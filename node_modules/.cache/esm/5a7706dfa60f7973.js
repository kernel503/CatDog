let createClient;_a60‍.w("contentful",[["createClient",["createClient"],function(v){createClient=v}]]);
...
getAllEmployee
  .then((result) => {
    ...
    _a60‍.g.console.log(employeeList);
  })
  .catch((error) => _a60‍.g.console.log(error));
